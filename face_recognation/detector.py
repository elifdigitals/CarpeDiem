...
def compare_encodings(encoding1: np.ndarray, encoding2: np.ndarray, tolerance: float = 0.6) -> bool:
    return face_recognition.compare_faces([encoding1], encoding2, tolerance=tolerance)[0]
